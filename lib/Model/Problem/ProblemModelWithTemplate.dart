...
class ProblemModelWithTemplate {
  final int problemId;
  ...
  factory ProblemModelWithTemplate.fromJson(Map<String, dynamic> json) {
    return ProblemModelWithTemplate(
