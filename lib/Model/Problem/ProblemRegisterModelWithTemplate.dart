...
class ProblemRegisterModelWithTemplate {
  int? problemId;
  ...
  factory ProblemRegisterModelWithTemplate.fromJson(Map<String, dynamic> json) {
    return ProblemRegisterModelWithTemplate(
